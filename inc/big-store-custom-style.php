...
// Slider BG 
  ...
  /**************************/
   ...
   $big_store_style.=".header-icon a ,.header-support-icon a.whishlist, .thunk-icon .cart-icon a.cart-contents i,.cat-icon,.sticky-header .header-icon a , .sticky-header .thunk-icon .cart-icon a.cart-contents,.responsive-main-header .header-support-icon a,.responsive-main-header .thunk-icon .cart-icon a.cart-contents,.responsive-main-header .menu-toggle .menu-btn,.sticky-header-bar .menu-toggle .menu-btn,.header-icon a.account,.header-icon a.prd-search .header-support-icon a.compare i {background:{$big_store_sq_icon_bg_clr};color:{$big_store_sq_icon_clr};} 
    ...
    .cat-icon span,.menu-toggle .icon-bar{background:{$big_store_sq_icon_clr};}.thunk-icon .taiowcp-icon ,.header-support-icon .taiowcp-icon .th-icon, .header-support-icon .taiowc-icon .th-icon, .sticky-header-col3 .taiowcp-icon .th-icon, .sticky-header-col3 .taiowc-icon .th-icon, .taiowcp-content .taiowcp-total, .taiowc-content .taiowcp-total,.header-support-icon a.whishlist span, .header-support-icon a.compare span{color:{$big_store_sq_icon_clr};} .thunk-icon .taiowcp-content .taiowcp-total,.thunk-icon .taiowc-content .taiowc-cart-item,.header-icon a, .sticky-header-col3 .header-icon a, .sticky-header-col3 .header-icon a.prd-search-icon > .tapsp-search-box > .th-icon, .header-icon a.prd-search-icon > .thaps-search-box > .th-icon,.sticky-header-col3 .header-icon a.prd-search-icon > .thaps-search-box > .th-icon,.header-icon a.prd-search-icon > .tapsp-search-box > .th-icon,.responsive-main-header .taiowcp-icon .th-icon, .responsive-main-header .taiowc-icon .th-icon{color:{$big_store_sq_icon_clr};} .thunk-icon .taiowcp-icon, .thunk-icon .taiowcp-cart-item,.header-icon a, .sticky-header-col3 .header-icon a, .sticky-header-col3 .header-icon a.prd-search-icon > .tapsp-search-box > .th-icon, .sticky-header-col3 .header-icon a.prd-search-icon > .thaps-search-box > .th-icon,.header-icon a.prd-search-icon > .tapsp-search-box > .th-icon,.header-support-icon .taiowc-wrap,.header-support-icon .taiowcp-wrap,  .sticky-header-col3 .taiowc-wrap, .sticky-header-col3 .taiowcp-wrap,.responsive-main-header .taiowc-wrap, .responsive-main-header .taiowcp-wrap,.header-icon a.prd-search-icon > .thaps-search-box > .th-icon{background:{$big_store_sq_icon_bg_clr};}";
