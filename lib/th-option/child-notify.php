...
class ThemeHunk_Child_Notify{
	...
	function notify(){
        ...
        <p><?php _e( 'We highly recommended to use child theme. Child theme inherit the style and functionality of parent theme, you can easily update the parent theme without losing its Customization. Thats why we recommended to use child theme to make your site update proof.', 'big-store' ); ?></p>
