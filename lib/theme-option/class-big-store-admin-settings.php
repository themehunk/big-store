		...
		static public function big_store_welcome_page_five_star_scetion(){
			...
			<div class="postbox">
				...
				<div class="inside">
					...
					<?php
						$big_store_support_link       = apply_filters( 'big_store_support_link','https://www.support.themehunk.com/');
			...
			<div class="postbox">
				...
				<div class="inside">
					<p>
                      ...
                      <?php
						$big_store_pro_link       = apply_filters( 'big_store_pro_link', 'https://themehunk.com/product/big-store-pro/' );
